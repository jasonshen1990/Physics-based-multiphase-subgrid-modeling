    ...
    for j = 1:length(rho)
        ...
        for k = 1:length(ReD)
            ...
            for l = 1:length(phi)
                ...
                for m = 1:length(ur)
                    ur_temp = ur(m);
                    [kr_theo(1,m,l,k,j,i),kr_theo(2,m,l,k,j,i)] = kratio(dp,ReD_temp,rho_temp,phi_temp,ur_temp,dr);
                end
            end
        end
    end
...
% line 4: rho = 0; phi = 0.01; ReD = 5; ur = 2;
...
% line 5: rho = 0; phi = 0.01; ReD = 40; ur = 2;
plot(squeeze(plot1tempx(5,1:n51,1)),squeeze(plot1tempy(5,1:n51,1)),'b>','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(5,1:n52,2)),squeeze(plot1tempy(5,1:n52,2)),'r>','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(5,1:n53,3)),squeeze(plot1tempy(5,1:n53,3)),'k>','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(5,1:n54,4)),squeeze(plot1tempy(5,1:n54,4)),'>','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
% line 6: rho = 0; phi = 0.01; ReD = 400; ur = 2;
plot(squeeze(plot1tempx(6,1:n61,1)),squeeze(plot1tempy(6,1:n61,1)),'bv','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(6,1:n62,2)),squeeze(plot1tempy(6,1:n62,2)),'rv','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(6,1:n63,3)),squeeze(plot1tempy(6,1:n63,3)),'kv','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(6,1:n64,4)),squeeze(plot1tempy(6,1:n64,4)),'v','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
hold off;
grid
axis([-1 2 0.95 1.15]);
...
plot(squeeze(plot1tempx(3,1:n33,3)),squeeze(plot1tempy(3,1:n33,3)),'kd','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(3,1:n34,4)),squeeze(plot1tempy(3,1:n34,4)),'d','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
% line 4: rho = 0; phi = 0.05; ReD = 5; ur = 2;
plot(squeeze(plot1tempx(4,1:n41,1)),squeeze(plot1tempy(4,1:n41,1)),'b*','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(4,1:n42,2)),squeeze(plot1tempy(4,1:n42,2)),'r*','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(4,1:n43,3)),squeeze(plot1tempy(4,1:n43,3)),'k*','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(4,1:n44,4)),squeeze(plot1tempy(4,1:n44,4)),'*','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
% line 5: rho = 0; phi = 0.05; ReD = 40; ur = 2;
plot(squeeze(plot1tempx(5,1:n51,1)),squeeze(plot1tempy(5,1:n51,1)),'b>','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(5,1:n52,2)),squeeze(plot1tempy(5,1:n52,2)),'r>','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(5,1:n53,3)),squeeze(plot1tempy(5,1:n53,3)),'k>','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(5,1:n54,4)),squeeze(plot1tempy(5,1:n54,4)),'>','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
% line 6: rho = 0; phi = 0.05; ReD = 400; ur = 2;
plot(squeeze(plot1tempx(6,1:n61,1)),squeeze(plot1tempy(6,1:n61,1)),'bv','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(6,1:n62,2)),squeeze(plot1tempy(6,1:n62,2)),'rv','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(6,1:n63,3)),squeeze(plot1tempy(6,1:n63,3)),'kv','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(6,1:n64,4)),squeeze(plot1tempy(6,1:n64,4)),'v','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
...
plot(squeeze(plot1tempx(3,1:n33,3)),squeeze(plot1tempy(3,1:n33,3)),'kd','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(3,1:n34,4)),squeeze(plot1tempy(3,1:n34,4)),'d','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
% line 4: rho = 0; phi = 0.2; ReD = 5; ur = 2;
plot(squeeze(plot1tempx(4,1:n41,1)),squeeze(plot1tempy(4,1:n41,1)),'b*','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(4,1:n42,2)),squeeze(plot1tempy(4,1:n42,2)),'r*','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(4,1:n43,3)),squeeze(plot1tempy(4,1:n43,3)),'k*','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(4,1:n44,4)),squeeze(plot1tempy(4,1:n44,4)),'*','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
% line 5: rho = 0; phi = 0.2; ReD = 40; ur = 2;
plot(squeeze(plot1tempx(5,1:n51,1)),squeeze(plot1tempy(5,1:n51,1)),'b>','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(5,1:n52,2)),squeeze(plot1tempy(5,1:n52,2)),'r>','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(5,1:n53,3)),squeeze(plot1tempy(5,1:n53,3)),'k>','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(5,1:n54,4)),squeeze(plot1tempy(5,1:n54,4)),'>','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
% line 6: rho = 0; phi = 0.2; ReD = 400; ur = 2;
plot(squeeze(plot1tempx(6,1:n61,1)),squeeze(plot1tempy(6,1:n61,1)),'bv','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(6,1:n62,2)),squeeze(plot1tempy(6,1:n62,2)),'rv','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(6,1:n63,3)),squeeze(plot1tempy(6,1:n63,3)),'kv','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(6,1:n64,4)),squeeze(plot1tempy(6,1:n64,4)),'v','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
...
plot(squeeze(plot1tempx(3,1:n33,3)),squeeze(plot1tempy(3,1:n33,3)),'kd','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(3,1:n34,4)),squeeze(plot1tempy(3,1:n34,4)),'d','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
% line 4: rho = 2.56; phi = 0.01; ReD = 5; ur = 2;
plot(squeeze(plot1tempx(4,1:n41,1)),squeeze(plot1tempy(4,1:n41,1)),'b*','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(4,1:n42,2)),squeeze(plot1tempy(4,1:n42,2)),'r*','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(4,1:n43,3)),squeeze(plot1tempy(4,1:n43,3)),'k*','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(4,1:n44,4)),squeeze(plot1tempy(4,1:n44,4)),'*','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
% line 5: rho = 2.56; phi = 0.01; ReD = 40; ur = 2;
plot(squeeze(plot1tempx(5,1:n51,1)),squeeze(plot1tempy(5,1:n51,1)),'b>','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(5,1:n52,2)),squeeze(plot1tempy(5,1:n52,2)),'r>','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(5,1:n53,3)),squeeze(plot1tempy(5,1:n53,3)),'k>','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(5,1:n54,4)),squeeze(plot1tempy(5,1:n54,4)),'>','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
% line 6: rho = 2.56; phi = 0.01; ReD = 400; ur = 2;
plot(squeeze(plot1tempx(6,1:n61,1)),squeeze(plot1tempy(6,1:n61,1)),'bv','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(6,1:n62,2)),squeeze(plot1tempy(6,1:n62,2)),'rv','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(6,1:n63,3)),squeeze(plot1tempy(6,1:n63,3)),'kv','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(6,1:n64,4)),squeeze(plot1tempy(6,1:n64,4)),'v','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
...
plot(squeeze(plot1tempx(3,1:n33,3)),squeeze(plot1tempy(3,1:n33,3)),'kd','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(3,1:n34,4)),squeeze(plot1tempy(3,1:n34,4)),'d','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
% line 4: rho = 2.56; phi = 0.05; ReD = 5; ur = 2;
plot(squeeze(plot1tempx(4,1:n41,1)),squeeze(plot1tempy(4,1:n41,1)),'b*','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(4,1:n42,2)),squeeze(plot1tempy(4,1:n42,2)),'r*','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(4,1:n43,3)),squeeze(plot1tempy(4,1:n43,3)),'k*','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(4,1:n44,4)),squeeze(plot1tempy(4,1:n44,4)),'*','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
% line 5: rho = 2.56; phi = 0.05; ReD = 40; ur = 2;
plot(squeeze(plot1tempx(5,1:n51,1)),squeeze(plot1tempy(5,1:n51,1)),'b>','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(5,1:n52,2)),squeeze(plot1tempy(5,1:n52,2)),'r>','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(5,1:n53,3)),squeeze(plot1tempy(5,1:n53,3)),'k>','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(5,1:n54,4)),squeeze(plot1tempy(5,1:n54,4)),'>','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
% line 6: rho = 2.56; phi = 0.05; ReD = 400; ur = 2;
plot(squeeze(plot1tempx(6,1:n61,1)),squeeze(plot1tempy(6,1:n61,1)),'bv','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(6,1:n62,2)),squeeze(plot1tempy(6,1:n62,2)),'rv','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(6,1:n63,3)),squeeze(plot1tempy(6,1:n63,3)),'kv','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(6,1:n64,4)),squeeze(plot1tempy(6,1:n64,4)),'v','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
...
plot(squeeze(plot1tempx(3,1:n33,3)),squeeze(plot1tempy(3,1:n33,3)),'kd','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(3,1:n34,4)),squeeze(plot1tempy(3,1:n34,4)),'d','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
% line 4: rho = 2.56; phi = 0.2; ReD = 5; ur = 2;
plot(squeeze(plot1tempx(4,1:n41,1)),squeeze(plot1tempy(4,1:n41,1)),'b*','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(4,1:n42,2)),squeeze(plot1tempy(4,1:n42,2)),'r*','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(4,1:n43,3)),squeeze(plot1tempy(4,1:n43,3)),'k*','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(4,1:n44,4)),squeeze(plot1tempy(4,1:n44,4)),'*','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
% line 5: rho = 2.56; phi = 0.2; ReD = 40; ur = 2;
plot(squeeze(plot1tempx(5,1:n51,1)),squeeze(plot1tempy(5,1:n51,1)),'b>','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(5,1:n52,2)),squeeze(plot1tempy(5,1:n52,2)),'r>','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(5,1:n53,3)),squeeze(plot1tempy(5,1:n53,3)),'k>','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(5,1:n54,4)),squeeze(plot1tempy(5,1:n54,4)),'>','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
% line 6: rho = 2.56; phi = 0.2; ReD = 400; ur = 2;
plot(squeeze(plot1tempx(6,1:n61,1)),squeeze(plot1tempy(6,1:n61,1)),'bv','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(6,1:n62,2)),squeeze(plot1tempy(6,1:n62,2)),'rv','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(6,1:n63,3)),squeeze(plot1tempy(6,1:n63,3)),'kv','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(6,1:n64,4)),squeeze(plot1tempy(6,1:n64,4)),'v','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
...
plot(squeeze(plot1tempx(3,1:n33,3)),squeeze(plot1tempy(3,1:n33,3)),'kd','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(3,1:n34,4)),squeeze(plot1tempy(3,1:n34,4)),'d','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
% line 4: rho = 1000; phi = 0.01; ReD = 5; ur = 2;
plot(squeeze(plot1tempx(4,1:n41,1)),squeeze(plot1tempy(4,1:n41,1)),'b*','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(4,1:n42,2)),squeeze(plot1tempy(4,1:n42,2)),'r*','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(4,1:n43,3)),squeeze(plot1tempy(4,1:n43,3)),'k*','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(4,1:n44,4)),squeeze(plot1tempy(4,1:n44,4)),'*','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
% line 5: rho = 1000; phi = 0.01; ReD = 40; ur = 2;
plot(squeeze(plot1tempx(5,1:n51,1)),squeeze(plot1tempy(5,1:n51,1)),'b>','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(5,1:n52,2)),squeeze(plot1tempy(5,1:n52,2)),'r>','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(5,1:n53,3)),squeeze(plot1tempy(5,1:n53,3)),'k>','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(5,1:n54,4)),squeeze(plot1tempy(5,1:n54,4)),'>','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
% line 6: rho = 1000; phi = 0.01; ReD = 400; ur = 2;
plot(squeeze(plot1tempx(6,1:n61,1)),squeeze(plot1tempy(6,1:n61,1)),'bv','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(6,1:n62,2)),squeeze(plot1tempy(6,1:n62,2)),'rv','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(6,1:n63,3)),squeeze(plot1tempy(6,1:n63,3)),'kv','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(6,1:n64,4)),squeeze(plot1tempy(6,1:n64,4)),'v','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
...
plot(squeeze(plot1tempx(3,1:n33,3)),squeeze(plot1tempy(3,1:n33,3)),'kd','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(3,1:n34,4)),squeeze(plot1tempy(3,1:n34,4)),'d','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
% line 4: rho = 1000; phi = 0.05; ReD = 5; ur = 2;
plot(squeeze(plot1tempx(4,1:n41,1)),squeeze(plot1tempy(4,1:n41,1)),'b*','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(4,1:n42,2)),squeeze(plot1tempy(4,1:n42,2)),'r*','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(4,1:n43,3)),squeeze(plot1tempy(4,1:n43,3)),'k*','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(4,1:n44,4)),squeeze(plot1tempy(4,1:n44,4)),'*','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
% line 5: rho = 1000; phi = 0.05; ReD = 40; ur = 2;
plot(squeeze(plot1tempx(5,1:n51,1)),squeeze(plot1tempy(5,1:n51,1)),'b>','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(5,1:n52,2)),squeeze(plot1tempy(5,1:n52,2)),'r>','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(5,1:n53,3)),squeeze(plot1tempy(5,1:n53,3)),'k>','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(5,1:n54,4)),squeeze(plot1tempy(5,1:n54,4)),'>','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
% line 6: rho = 1000; phi = 0.05; ReD = 400; ur = 2;
plot(squeeze(plot1tempx(6,1:n61,1)),squeeze(plot1tempy(6,1:n61,1)),'bv','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(6,1:n62,2)),squeeze(plot1tempy(6,1:n62,2)),'rv','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(6,1:n63,3)),squeeze(plot1tempy(6,1:n63,3)),'kv','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(6,1:n64,4)),squeeze(plot1tempy(6,1:n64,4)),'v','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
...
plot(squeeze(plot1tempx(3,1:n33,3)),squeeze(plot1tempy(3,1:n33,3)),'kd','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(3,1:n34,4)),squeeze(plot1tempy(3,1:n34,4)),'d','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
% line 4: rho = 1000; phi = 0.2; ReD = 5; ur = 2;
plot(squeeze(plot1tempx(4,1:n41,1)),squeeze(plot1tempy(4,1:n41,1)),'b*','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(4,1:n42,2)),squeeze(plot1tempy(4,1:n42,2)),'r*','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(4,1:n43,3)),squeeze(plot1tempy(4,1:n43,3)),'k*','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(4,1:n44,4)),squeeze(plot1tempy(4,1:n44,4)),'*','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
% line 5: rho = 1000; phi = 0.2; ReD = 40; ur = 2;
plot(squeeze(plot1tempx(5,1:n51,1)),squeeze(plot1tempy(5,1:n51,1)),'b>','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(5,1:n52,2)),squeeze(plot1tempy(5,1:n52,2)),'r>','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(5,1:n53,3)),squeeze(plot1tempy(5,1:n53,3)),'k>','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(5,1:n54,4)),squeeze(plot1tempy(5,1:n54,4)),'>','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
% line 6: rho = 1000; phi = 0.2; ReD = 400; ur = 2;
plot(squeeze(plot1tempx(6,1:n61,1)),squeeze(plot1tempy(6,1:n61,1)),'bv','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(6,1:n62,2)),squeeze(plot1tempy(6,1:n62,2)),'rv','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(6,1:n63,3)),squeeze(plot1tempy(6,1:n63,3)),'kv','Linewidth',1.0,'Markersize',8);
plot(squeeze(plot1tempx(6,1:n64,4)),squeeze(plot1tempy(6,1:n64,4)),'v','color','[0.4940 0.1840 0.5560]','Linewidth',1.5,'Markersize',8);
