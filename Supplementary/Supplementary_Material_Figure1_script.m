...
title('$\rho = 0$ (bubbles in water), $\phi = 1\%$, $u_r = 0$','Fontsize',12,'interpreter','Latex');
...
%xlabel('$\log_{10}\left(D/\eta_{sp}\right)$','Fontsize',14,'interpreter','Latex');
%ylabel('$k_{mp}/k_{sp}$','Fontsize',14,'interpreter','Latex');
title('$\rho = 0$ (bubbles in water), $\phi = 5\%$, $u_r = 0$','Fontsize',12,'interpreter','Latex');
xticks([-1 -0.5 0 0.5 1 1.5 2]);
yticks([0 1.0 2.0 3.0 4.0]);
aaa = get(gca,'XTick');
set(gca,'XTick',aaa,'fontname','Times','fontsize',17)
...
%xlabel('$\log_{10}\left(D/\eta_{sp}\right)$','Fontsize',14,'interpreter','Latex');
%ylabel('$k_{mp}/k_{sp}$','Fontsize',14,'interpreter','Latex');
title('$\rho = 0$ (bubbles in water), $\phi = 20\%$, $u_r = 0$','Fontsize',12,'interpreter','Latex');
xticks([-1 -0.5 0 0.5 1 1.5 2]);
yticks([0 1.0 2.0 3.0 4.0]);
aaa = get(gca,'XTick');
set(gca,'XTick',aaa,'fontname','Times','fontsize',17)
...
%xlabel('$\log_{10}\left(D/\eta_{sp}\right)$','Fontsize',14,'interpreter','Latex');
ylabel('$k_{mp}/k_{sp}$','Fontsize',14,'interpreter','Latex');
title('$\rho = 2.56$ (sand in water), $\phi = 1\%$, $u_r = 0$','Fontsize',12,'interpreter','Latex');
xticks([-1 -0.5 0 0.5 1 1.5 2]);
yticks([0 1.0 2.0 3.0 4.0]);
aaa = get(gca,'XTick');
set(gca,'XTick',aaa,'fontname','Times','fontsize',17)
...
%xlabel('$\log_{10}\left(D/\eta_{sp}\right)$','Fontsize',14,'interpreter','Latex');
%ylabel('$k_{mp}/k_{sp}$','Fontsize',14,'interpreter','Latex');
title('$\rho = 2.56$ (sand in water), $\phi = 5\%$, $u_r = 0$','Fontsize',12,'interpreter','Latex');
xticks([-1 -0.5 0 0.5 1 1.5 2]);
yticks([0 1.0 2.0 3.0 4.0]);
aaa = get(gca,'XTick');
set(gca,'XTick',aaa,'fontname','Times','fontsize',17)
...
%xlabel('$\log_{10}\left(D/\eta_{sp}\right)$','Fontsize',14,'interpreter','Latex');
%ylabel('$k_{mp}/k_{sp}$','Fontsize',14,'interpreter','Latex');
title('$\rho = 2.56$ (sand in water), $\phi = 20\%$, $u_r = 0$','Fontsize',12,'interpreter','Latex');
xticks([-1 -0.5 0 0.5 1 1.5 2]);
yticks([0 1.0 2.0 3.0 4.0]);
aaa = get(gca,'XTick');
set(gca,'XTick',aaa,'fontname','Times','fontsize',17)
...
xlabel('$\log_{10}\left(D/\eta_{sp}\right)$','Fontsize',14,'interpreter','Latex');
ylabel('$k_{mp}/k_{sp}$','Fontsize',14,'interpreter','Latex');
title('$\rho = 1000$ (drop in air), $\phi = 1\%$, $u_r = 0$','Fontsize',12,'interpreter','Latex');
xticks([-1 -0.5 0 0.5 1 1.5 2]);
yticks([0 1.0 2.0 3.0 4.0]);
aaa = get(gca,'XTick');
set(gca,'XTick',aaa,'fontname','Times','fontsize',17)
...
xlabel('$\log_{10}\left(D/\eta_{sp}\right)$','Fontsize',14,'interpreter','Latex');
%ylabel('$k_{mp}/k_{sp}$','Fontsize',14,'interpreter','Latex');
title('$\rho = 1000$ (drop in air), $\phi = 5\%$, $u_r = 0$','Fontsize',12,'interpreter','Latex');
xticks([-1 -0.5 0 0.5 1 1.5 2]);
yticks([0 1.0 2.0 3.0 4.0]);
aaa = get(gca,'XTick');
set(gca,'XTick',aaa,'fontname','Times','fontsize',17)
...
xlabel('$\log_{10}\left(D/\eta_{sp}\right)$','Fontsize',14,'interpreter','Latex');
%ylabel('$k_{mp}/k_{sp}$','Fontsize',14,'interpreter','Latex');
title('$\rho = 1000$ (drop in air), $\phi = 20\%$, $u_r = 0$','Fontsize',12,'interpreter','Latex');
xticks([-1 -0.5 0 0.5 1 1.5 2]);
yticks([0 1.0 2.0 3.0 4.0]);
aaa = get(gca,'XTick');
set(gca,'XTick',aaa,'fontname','Times','fontsize',17)
